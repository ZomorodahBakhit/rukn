...
function App() {
  ...
  const onSignup = () => setOverlay("signup");
  const onLogin = () => { window.location.href = "Login.html#login"; };
  const goRegister = () => { window.location.href = "Login.html#register"; };
  const goLogin = () => { window.location.href = "Login.html#login"; };
